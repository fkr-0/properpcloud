        ...
        setContent {
            ...
            ProperpcloudApp(
                ...
                actions = AppActions(
                    ...
                    switchAudioTab = viewModel::switchAudioTab,
                    addAudioTab = viewModel::addAudioTab,
                    updateAudioTab = viewModel::updateAudioTab,
                    removeAudioTab = viewModel::removeAudioTab,
                    playTrack = viewModel::playTrack,
                    resumeTrack = viewModel::resumeTrack,
                    ...
                    saveCurrentPlaylist = viewModel::saveCurrentPlaylist,
                    loadSavedPlaylist = viewModel::loadSavedPlaylist,
